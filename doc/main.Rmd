...
Per document view help to cofidently conclude that it is no the sweetness of message that characterises a successful write up, and the assumption that successful listings are puraly more positive is wrong. It is not the polarity of emotion, but amount of emotion drives success.
